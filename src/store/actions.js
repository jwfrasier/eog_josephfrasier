...
export const RECEIVE_DRONE_DATA = "EVENT/RECEIVE_DRONE_DATA";
export const POLL_DRONE_DATA = "EVENT/POLL_DRONE_DATA";
export const POLL_START = "EVENT/POLL_START";
export const POLL_STOP = "EVENT/POLL_STOP";
